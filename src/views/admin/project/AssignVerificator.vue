<template>
  <section class="project-preview-wrapper">
    ...
    <!-- error -->
    <add-verificator
      :is-add-new-verificator-sidebar-active.sync="isAddNewVerificatorSidebarActive"
      ...
      >
        ...
        >
          ...
          <b-card-body>
            <b-button
              variant="primary"
              @click="isAddNewVerificatorSidebarActive = true"
            >
              <span class="text-nowrap">Add Verificator</span>
            </b-button>
            <!-- table -->
            <vue-good-table
              :columns="columns"
...
import AddVerificator from './AddVerificator.vue'
...
export default {
  ...
  setup() {
    ...
    const isAddNewVerificatorSidebarActive = ref(false)
    ...
    store.dispatch('app-project/fetchVerificator', { id: router.currentRoute.params.id })
      .then(response => {
    ...
    const deleteUser = userId => {
      Vue.swal({
        ...
        if (result.value) {
          ...
          store.dispatch('app-project/deleteVerificator', {
            userId,
          })
            .then(() => {
